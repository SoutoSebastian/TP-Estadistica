...
En el histograma bootstrap se observa que la distribución del estimador de momentos es muy dispersa y presenta barras bien separadas. Esto ocurre porque, con un tamaño muestral tan pequeño como n=10, la proporción muestral $\hat{p}$ solo puede tomar pocos valores posibles, lo que genera una distribución discreta y “a saltos”.
En conjunto, el gráfico muestra que para $n=10$ el estimador de momentos es muy impreciso y altamente variable, por lo que no es confiable en muestras tan pequeñas. Se recomendaria aumentar el tamaño de la muestra para obtener estimaciones mas utiles.
...
### 2.1.11 Comparación entre ambos intervalos.
