...
Para el test imperfecto consideramos un modelo donde la variable observada  
\(T\) proviene de un test con sensibilidad \(Se\) y especificidad \(Sp\).
...
El estimador de momentos corregido para \(\theta\) es:
...
por lo que el ECM teórico coincide con la varianza teórica.
